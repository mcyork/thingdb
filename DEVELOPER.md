...
│   ├── .env               # Configuration (preserved on upgrade)
│   ├── venv/              # Python virtual environment
│   └── src/thingdb/       # Source code
├── ssl/                   # SSL certificates
│   ├── cert.pem          # Certificate
│   ├── key.pem           # Private key
│   └── .thingdb_marker   # Identifies our certs
├── images/                # Uploaded images
├── backups/               # Database backups
├── cache/models/          # ML models (200MB)
└── INSTALL_INFO           # Version tracking
```
